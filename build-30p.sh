...
make O=$OUT REAL_CC=/home/linx/Project/srcCode/gauguin-r-oss/toolchains/llvm-Snapdragon_LLVM_for_Android_8.0/prebuilt/linux-x86_64/bin/clang CLANG_TRIPLE=aarch64-linux-gnu- lmi_user_defconfig

cp .config out/
cp kernel.release-30p out/include/config/kernel.release
cp compile.h-30p out/include/generated/compile.h
